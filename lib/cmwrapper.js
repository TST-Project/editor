...
window.cmWrapper = (function() {
    ...
    const getSchema = function(s) {
        const schemae = {
            ...
            descriptive_restricted: ['term','note','emph','ex','expan','title','locus','material','ref','q','date','watermark','list','item','stamp'],
        ...
        const tags = {
            ...
            unclear: {
                attrs: {
                    reason: ['blemish','rubbed','messy','damaged','vowel_unclear','eccentric_ductus'],
                }
            },
            damage: {
                attrs: {
