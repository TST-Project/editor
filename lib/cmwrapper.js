    ...
    */
    ...
    const getSchema = function(s) {
        ...
        const tags = {
            ...
            seg: {
                attrs: {
                    'function': ['blessing','colophon','commenting-note','completion-statement','chapter-heading','correction','date','dedication','documenting-note','end-title','explicit','gloss','heading','incipit','intertitle','invocation','metre','note','ownership-statement','postface','preface','register','rubric','running-title','satellite-stanza','shelfmark','stamp','summary','title','table-of-contents','total-chapters','total-leaves','total-stanzas','verse-beginning','verse-numbering'],
                    'rend': ['grantha'],
