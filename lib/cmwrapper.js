...
window.cmWrapper = (function() {
    ...
    const getSchema = function(s) {
        ...
        const tags = {
            ...
            unclear: {
                attrs: {
                    reason: ['blemish','rubbed','messy','damaged','consonant_unclear','vowel_unclear','eccentric_ductus'],
                }
            },
            damage: {
                attrs: {
            ...
            gap: {
                attrs: {
                    reason: ['ellipsis','damaged','illegible'],
                    unit: attrs.units,
                    quantity: null,
                },
            },
            ...
            seg: {
                attrs: {
                    'function': ['blessing','colophon','commenting-note','completion-statement','chapter-heading','correction','dedication','documenting-note','end-title','explicit','gloss','heading','incipit','intertitle','invocation','postface','preface','register','rubric','running-title','satellite-stanza','shelfmark','stamp','title','table-of-contents','total-stanzas','total-chapters','verse-beginning','verse-numbering'],
                },
