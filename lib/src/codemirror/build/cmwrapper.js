import './lib/cmglobal.js';
import CodeMirror from './pkg/codemirror.js';
import './pkg/codemirror/mode/xml/xml.js';
import './pkg/codemirror/addon/hint/show-hint.js';
import './lib/xml-hint.js';
import './lib/htmlhint-custom.js';
import './pkg/codemirror/addon/lint/lint.js';
import './lib/xml-lint.js';
import './pkg/codemirror/addon/display/placeholder.js';
...
const getSchema = function(s) {
    const schemae = {
        transcription: ['milestone','lb','pb','add','choice','del','seg','subst','supplied','surplus','hi','space','unclear','gap','damage','supplied','g'], 
    ...
    const tags = {
        ...
        seg: {
            attrs: {
                'function': ['blessing','colophon','commenting-note','completion-statement','chapter-heading','correction','date','dedication','documenting-note','end-title','ex-libris','explicit','gloss','heading','incipit','intertitle','invocation','metre','note','ownership-statement','postface','preface','register','rubric','running-title','satellite-stanza','shelfmark','stage-directions','stamp','summary','title','table-of-contents','total-chapters','total-leaves','total-stanzas','verse-beginning','verse-numbering'],
                'rend': ['grantha'],
        ...
        persName: {
            attrs: {
                'xml:id': null,
                'role': ['author','commentator','commissioner','editor','owner','scribe'],
                'cert': ['low'],
                'ref': null
            },
        },
